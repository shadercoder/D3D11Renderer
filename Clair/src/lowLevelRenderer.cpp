...
VertexShader* LowLevelRenderer::createVertexShader(char* const vsData, const size_t vsSize) {
	HRESULT result {};
...
PixelShader* LowLevelRenderer::createPixelShader(char* const psData, const size_t psSize) {
	HRESULT result {};
